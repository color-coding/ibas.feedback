...
namespace feedback {
    export namespace bo {
        ...
        /** 建议 */
        export class Suggestion extends ibas.BOSimple<Suggestion> implements ISuggestion {
            ...
            get closed(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(Suggestion.PROPERTY_CLOSED_NAME);
            }
            /** 设置-是否关闭 */
            ...
            /** 初始化数据 */
            protected init(): void {
                this.objectCode = ibas.config.applyVariables(Suggestion.BUSINESS_OBJECT_CODE);
            }
        }
    }
}
